...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "COOPERNIK — La plateforme des clubs business" },
      { name: "description", content: "L'outil dédié aux clubs business et réseaux professionnels : annuaire, messagerie, business tracking et évènements." },
      { name: "author", content: "COOPERNIK" },
      { property: "og:title", content: "COOPERNIK — La plateforme des clubs business" },
      { property: "og:description", content: "Annuaire, messagerie, business tracking et évènements pour clubs business et réseaux pro." },
